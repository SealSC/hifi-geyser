  ...
  <div class="wallet-container">
    <div class="row">
      <div class="col text-center">
        <img class="home-logo" :src="'/static/logo/logo-long.png'" alt=""/>
      </div>
    </div>
    <div class="row">
        ...
        <div class="supply-col-div">
          <div class="row">
            <div class="col">
              ...
              <p v-if="totalReward" class="preview-txt">{{ $HelperTools.toFinancialVal(totalReward) }}</p>
            </div>
          </div>
          <div class="row stats-div">
            <div class="col-7 stats-txt">{{ $t("home.rewards") }}</div>
            <div class="col-5 text-right stats-txt">{{ $HelperTools.toFinancialVal(rewardsBalance) }} {{ $t("token.name") }}</div>
          </div>
        </div>
      </div>
    </div>
